...
export default class ScreenChooseRoom extends React.Component {
    constructor() {
        super();
    ...
    joinRoom(room) {
        room = this.removeDiacritics(room);
        ...
        return (
            <SafeAreaView style={styles.home}>
                <View style={styles.header}>
                    <Text style={styles.infoText}>{global.name}</Text>
                    <TouchableOpacity style={styles.logout} onPress={() => this.props.navigation.navigate('ChooseName')}>
                ...
                <View style={styles.listRooms}>
                    ...
                    <View style={styles.rooms}>
                        <Text style={styles.title}>{global.rooms.length>1?"Salons rejoints":"Salon rejoint"}</Text>
                        ...
                        <FlatList
                            ...
                            data={global.rooms}
                            renderItem={({ item }) => <TouchableOpacity style={styles.roomLink} onPress={()=>this.joinRoom(item)}><Text>{item}</Text><TouchableOpacity style={styles.leaveButton} onPress={()=>this.leaveRoom(item)}><Text style={{color: "#FFF"}}>Quitter</Text></TouchableOpacity></TouchableOpacity>}
                        />
                    </View>
                </View>
